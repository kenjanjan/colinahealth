...
const Footer = () => {
  ...
  return (
    <div className={`${baseRoute==="login"?"":"fixed"} flex w-full items-center justify-between h-[40px] bg-[#FAFAFA] lg:px-[150px] md:px-0 text-[12px] font-semibold min-h-[40px] bottom-0`}>
