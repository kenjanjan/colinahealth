  ...
  return (
    <div className={`w-full max-w-[166px] w-${width} `} ref={menuRef}>
      <button
        ...
        className={`flex h-[47px] items-center justify-between rounded-[5px] bg-white  text-[15px] font-bold text-[#191D23] ${!isCheckBox ? "w-full text-opacity-60 p-4 shadow-sm" : "uppercase text-[#64748B]"}`}
      >
        {optionLabel}
        <Image
